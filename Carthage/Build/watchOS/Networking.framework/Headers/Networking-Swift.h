...
@interface NSFileManager (SWIFT_EXTENSION(Networking))
- (BOOL)existsAt:(NSURL * _Nonnull)url SWIFT_WARN_UNUSED_RESULT;
- (BOOL)removeAt:(NSURL * _Nonnull)url error:(NSError * _Nullable * _Nullable)error;
@end
...
@interface UIImage (SWIFT_EXTENSION(Networking))
+ (UIImage * _Nonnull)findWithNamed:(NSString * _Nonnull)name inBundle:(NSBundle * _Nonnull)bundle SWIFT_WARN_UNUSED_RESULT;
- (NSData * _Nullable)pngData SWIFT_WARN_UNUSED_RESULT;
- (NSData * _Nullable)jpgData SWIFT_WARN_UNUSED_RESULT;
@end
